<ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ route('drivers.index') }}"><i class="fas fa-truck text-cyan"></i>All Drivers</a>
                        <a class="dropdown-item" href="{{ route('attendance.index') }}"><i class="far fa-calendar-check text-blue"></i>Attendance</a>
                    </div>
                </li>
{{--                <li class="nav-item">--}}
