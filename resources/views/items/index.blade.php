                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-import-items" onClick=(setRestaurantId({{ $restorant_id }}))>Import from CSV</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <form action="{{ route('categories.destroy', $category) }}" method="post">
                                            ...
                                            @if(count($category->items) > 0)
                                                <!--<button class="btn btn-icon btn-1 btn-sm btn-danger" type="submit" onclick="confirm('{{ __("Are you sure you want to delete this category?") }}') ? this.parentElement.submit() : ''" data-toggle="tooltip" data-placement="top" title="{{ __('Delete') }} {{$category->name}}">-->
